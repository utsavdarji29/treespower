                          ...
                          <div class="admin-dashboard-right">
                            ...
                            <div class="admin-dashboard-searchbar-part">
                                ...
                                <div class="admin-dashboard-searchbar">
                                    ...
                                    <form method="get" action="{{ route('adminpanel.manager.search') }}" enctype="multipart/form-data" style="display: flex;" id="search_form">
                            ...
                            <div class="admin-dashboard-user-dtl">
                                ...
                                <div class="admin-dashboard-user-left-dtl">
                                    ...
                                    <div class="admin-dashboard-user-name">
                                        ...
                                        <h2>Manager: (<span>{{ $data1['Managers'] }}</span>)</h2>
                                ...
                                <div class="admin-dashboard-user-right-dtl">
                                    ...
                                    <div class="admin-dashboard-sing-plus-icon">
                                        ...
                                        <a href="{{ route('adminpanel.manager.add') }}"><img src="{{ asset('managerpanel/images/plus.png') }}"></a>
                                                ...
                                                <td style="text-align: right;width: 27%">
                                                    ...
                                                    <div class="users-edit dropdown-menu-list">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item" href="{{ url('/adminpanel/editmanager/'.$d->id) }}"><span><i class="fas fa-edit"></i></span>Edit</a>

                                                            <a class="dropdown-item delete-confirm" href="{{ url('/adminpanel/deletemanager/'.$d->id) }}"><span><i class="fas fa-trash-alt"></i></span>Delete</a>

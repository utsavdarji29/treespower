                        ...
                        <div class="user-details-modal-main add-users-sub-dtl view-job-dtl-main">
                            <div class="user-details-sub-dtl">
                                <div class="user-details-head">
                                    <h2>Tree Report:</h2>
                                    @foreach ($tree as $d)
                                        <button class="btn-main"><a href="{{ url('/adminpanel/edittree/'.$d->id) }}"><span><i class="fas fa-edit"></i></span>Edit</a></button>
                                    @endforeach
                                </div>
                                        ...
                                        <div class="add-users-form">
                                            ...
                                            @foreach ($tree as $d) 
                                                <table class="table table-striped table-bordered" style="width:100%">
                                                    ...
                                                    <tr>
                                                        <td><a href="{{ url('/adminpanel/qrcode/'.$d->id) }}">View Qr Code</a></td>
                                                    </tr>
                                                </table>
                                            @endforeach
                                            </div>

                        ...
                        <div class="admin-dashboard-searchbar-part">
                            ...
                            <div class="admin-dashboard-searchbar" id="dvPassport" style="display: none">
                                <!-- <span class="search-icn"><img src="{{ asset('managerpanel/images/search.png') }}"></span> -->
                                    ...
                                    @csrf
                                        <input class="search-sm" type="date" name="search" placeholder="Search..." aria-label="Search">

                                        <div class="input-group-append">
                                            <button class="search-icn"><i class="fa fa-search"></i></button>
                                            <!-- <input type="submit" name="submit" value="search" class="btn-main" > -->
                            ...
                            <div class="admin-dashboard-searchbar" id="dvPassport1" style="display: none">
                                <span class="search-icn"><img src="{{ asset('managerpanel/images/search.png') }}"></span>
                                    ...
                                    <form method="get" action="{{ route('adminpanel.job.search') }}" enctype="multipart/form-data" style="display: flex;" id="search_form">
                                    @csrf
                                        <input class="search-sm" type="week" name="search" placeholder="Search..." aria-label="Search">
                            ...
                            <div class="admin-dashboard-searchbar" id="dvPassport2" style="display: none">
                                <span class="search-icn"><img src="{{ asset('managerpanel/images/search.png') }}"></span>
                                    ...
                                    <form method="get" action="{{ route('adminpanel.job.search') }}" enctype="multipart/form-data" style="display: flex;" id="search_form">
                                    @csrf
                                        <input class="search-sm" type="month" name="search" placeholder="Search..." aria-label="Search">
                                ...
                                <div class="manager-task-list-name">
                                    ...
                                    <div class="manager-task-list-name-left">
                                        <?php 
                                            $manager_id = "";
                                        ?>
                                        <form method="get" action="{{ route('adminpanel.job.searchjobmanager') }}" enctype="multipart/form-data" style="display: flex;">
                                                    @csrf
                                            <div class="edit-select">

                                                <div class="add-users-role country add-us-inp" style="width:177px;">
                                                    
                                                    <select class="add-us-inp" name="manager_id" id="manager_id" style="font-size:12px;">
                                                        <option>Select Manager Task</option>
                                                        @foreach ($manager as $m) 
                                                            ...
                                                            ?>
                                                            <option value="{{ $m->id}}" {{ $optionSelected }}>{{ $m->first_name }} {{ $m->last_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                    ...
                                    <table>
                                        <thead>
                                            <tr>
                                                ...
                                                <td style="text-align: center;">Start and <br/> End Time</td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">{{ $t->job_date }} </td>
                                                <td style="text-align: center;">{{ $t->start_time }}-{{ $t->end_time }} </td>
                                                <td style="text-align: center;;">{{ $t->job_title}} </td>
                                                    ...
                                                    <div class="users-edit dropdown-menu-list">
                                                        <a href="javascript:;" data-toggle="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <a class="dropdown-item delete-confirm" href="{{ url('/adminpanel/deletejob/'.$t->id) }}"><span><i class="fas fa-trash-alt"></i></span>Delete</a> -->
                                                            </div>
                                                        </div>
                                                </td>
                                            </tr>
                                    ...
                                    <div class="manageuser-new-tab-design">
                                        <div class="manager-tree-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="text-align: center;padding-left: 0px;">{{ $counter }}</td>
                                                    <td style="text-align: center;">{{ $i->job_date }} </td>
                                                    <td style="text-align: center;">{{ $i->start_time }}-{{ $i->end_time }} </td>
                                                    <td style="text-align: center;">{{ $i->job_title}} </td>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <div class="users-edit dropdown-menu-list">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <a class="dropdown-item delete-confirm" href="{{ url('/adminpanel/deletejob/'.$i->id) }}"><span><i class="fas fa-trash-alt"></i></span>Delete</a> -->
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;padding-left: 0px;">{{ $counter }}</td>
                                                <td style="text-align: center;">{{ $do->job_date }} </td>
                                                <td style="text-align: center;">{{ $do->start_time }}-{{ $do->end_time }} </td>
                                                <td style="text-align: center;">{{ $do->job_title}} </td>
                                                <td style="text-align: center;">{{ $do->address}} </td>
                                                    ...
                                                    <div class="users-edit dropdown-menu-list">
                                                        <a href="javascript:;" data-toggle="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <a class="dropdown-item delete-confirm" href="{{ url('/adminpanel/deletejob/'.$do->id) }}"><span><i class="fas fa-trash-alt"></i></span>Delete</a> -->
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>

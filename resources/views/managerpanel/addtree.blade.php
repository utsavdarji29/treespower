            ...
            <div class="admin-dashboard-right">
                ...
                <?php
                    ...
                    if(isset($data['error'])) {
                        ...
                        if($data['type']=="Edit") {
                            $label = "Edit";
                            $formRoute = route('managerpanel.tree.update');
                        }
                                                        ...
                                                        <div class="col-12" style="text-align: center;">
                                                            <div class="edit-tree-left-sing">
                                                                ...
                                                                <div class="edit-tree-left-sing-icn">
                                                                    ...
                                                                    <a class="delete-confirm" href="{{ url('/managerpanel/deletetreeimage/'.$img->id) }}"><img src="http://treespower.com.sg/treespower/public/managerpanel/images/blue-delete-icn.png"></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <?php
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                                            <div class="add-users-sm-inp form-group">
                                                                ...
                                                                <?php 
                                                                    ...
                                                                    $datePlanted = date("m/d/Y",$timestemp);*/
                                                                ?>

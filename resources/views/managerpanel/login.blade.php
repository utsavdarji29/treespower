        ...
        <div class="login-page-main">
            ...
            <div class="login-form-part-main">
                ...
                <?php
                    ...
                    $formURL = route('managerpanel.submitlogin');
                ...
                <div class="login-form-dtl-main">
                    ...
                    <form action="{{ $formURL }}" method="POST" id="logForm">
                        ...
                        <div class="login-form-inp-box login-form-emal-inp">
                            ...
                            <input type="text" name="email" value="{{ old('email') }}" class="login-inp" placeholder="Email" required="">
                ...
                <?php
                $forgotURL = route('managerpanel.forgotpassword');
                ?>

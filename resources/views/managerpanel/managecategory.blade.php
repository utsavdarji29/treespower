                                                ...
                                                <td style="text-align: right;width: 15%">
                                                    ...
                                                    <div class="users-edit dropdown-menu-list">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item" href="{{ url('/managerpanel/editcategory/'.$d->id) }}"><span><i class="fas fa-edit"></i></span>Edit</a>

                                                            <a class="dropdown-item delete-confirm" href="{{ url('/managerpanel/deletecategory/'.$d->id) }}"><span><i class="fas fa-trash-alt"></i></span>Delete</a>

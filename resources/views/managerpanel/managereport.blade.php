                        ...
                        <div class="admin-dashboard-right Manager-task-right-main">
                            <div class="admin-dashboard-searchbar-part">
                                ...
                                <div class="admin-dashboard-searchbar">
                                    ...
                                    <form method="get" action="{{ route('managerpanel.report.searchtreereport') }}" enctype="multipart/form-data" style="display: flex;" id="search_form1">
                                    @csrf
                                ...
                                <div class="admin-dashboard-searchbar">
                                    ...
                                    <form method="get" action="{{ route('managerpanel.report.searchtreereportlocation') }}" enctype="multipart/form-data" style="display: flex;" id="search_form1">
                                    @csrf
                                ...
                                <div class="admin-dashboard-searchbar" id="dvPassport" style="display: none">
                                    ...
                                    <form method="get" action="{{ route('managerpanel.report.search') }}" enctype="multipart/form-data" style="display: flex;" id="search_form">
                                    @csrf
                                        ...
                                        <div class="manager-task-list-name-left">
                                            <div class="edit-select">
                                                <div class="add-users-role country add-us-inp">
                                                 ...
                                                 <button class="btn btn-primary update_all" data-url="{{ url('managerpanel/updateReportAll/') }}"><i class="fa fa-edit"></i></button>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="users-edit dropdown-menu-list" style="padding-right: 0px;">
                                                        <a href="javascript:;" data-toggle="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" href="{{ url('/managerpanel/viewreport/'.$n->id) }}"><span><i class="fas fa-eye"></i></span>View</a>
                                                                <a class="dropdown-item delete-confirm" href="{{ url('/managerpanel/deletereport/'.$n->id) }}"><span><i class="fas fa-trash-alt"></i></span>Delete</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td style="text-align: center;width: 19%">
                                                    <div class="users-edit dropdown-menu-list" style="padding-right: 0px;">
                                                        <a href="javascript:;" data-toggle="dropdown">
                                                            <img src="http://treespower.com.sg/treespower/public/managerpanel/images/th-icon.png"></a>
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" href="{{ url('/managerpanel/viewreport/'.$c->id) }}"><span><i class="fas fa-eye"></i></span>View</a>
                                                                <a class="dropdown-item delete-confirm" href="{{ url('/managerpanel/deletereport/'.$c->id) }}"><span><i class="fas fa-trash-alt"></i></span>Delete</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>

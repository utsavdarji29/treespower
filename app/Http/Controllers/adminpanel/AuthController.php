...
class AuthController extends Controller
{
    ...
    public function forgotpassword(Request $request) 
    {
        ...
        if (count($checkMail) > 0) 
        {
            ...
            //return redirect()->back()->withInput()->('success', 'Password Sent to mail successfully.');
        }
        else
        {
            return redirect()->back()->withInput()->withErrors(['Email not found in our System.']);
            //return redirect()->route('adminpanel.login')->with('success', 'Email not found in our System.');
        }
    }
